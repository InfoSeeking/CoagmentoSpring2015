...
?>
  ...
  <body>
    ...
    <p>Click <a href="../instruments/22da5ad4.php">here</a> to complete the first questionnaire.</p>
  </body>
  </html>
  <?php
  exit();
...
<form id="spr2015_q_second" class="pure-form" method="post" action="ffd6f2e4.php">
  <center>
