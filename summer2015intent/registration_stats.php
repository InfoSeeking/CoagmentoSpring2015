...
<?php
$q = "select r.firstName, r.lastName, u.username, u.userID, u.projectID FROM recruits r, users u WHERE u.projectID!=0 AND r.userID=u.userID ORDER BY u.projectID";
$res = $cxn->commit($q);
