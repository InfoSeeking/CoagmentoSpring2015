	...
	?>
	    ...
	    <div id="title">
            ...
            <div class="navigation">
            	<a href="1.php">Today</a>
                <a href="2.php">Yesterday</a>
                <a href="3.php">Two Days Ago</a>
                <a href="4.php"><font color="#999">One Week Ago</font></a>
...
<table class="body" width=100%>
	<tr><td><div id="message"></div></td></tr>
		...
		<table class="body" border=0>
			...
			<td>&nbsp;<input type="button" value="Filter" onClick="filterAllData();" />&nbsp;&nbsp; </td>
		 ...
		 <? echo "<div class='records'>Displaying records for <font color='#999'>$oneweekago</font></div>" ?>
	...
	while ($line = mysql_fetch_array($results, MYSQL_ASSOC)) {
		...
		if($date == $oneweekago) {
		echo "<div class='section'><a href=\"$url\">$title</a> <br /> <img src='website-images/screenshot.png' width='100' height='56'> <br /> $date $time<br/></div>";
		$records++; }
	}
