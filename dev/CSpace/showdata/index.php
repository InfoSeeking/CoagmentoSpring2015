	...
	?>
	    ...
	    <div id="title">
            ...
            <div class="navigation">
                ...
                <a href="index.php"><font color="#999">All</font></a>
            </div>
		</div>
...
-->
			...
			<td>&nbsp;<input type="button" value="Filter" onClick="filterData();" />&nbsp;&nbsp;</td>
...
// 					echo "$query";
         ...
         <? echo "<div class='records'>Displaying <font color='#999'>all records</font></div>" ?>
