...
/* function first_image_from_website($url){
	...
	$query = "SELECT * FROM pages ORDER BY date,time LIMIT 36";
	$results = mysql_query($query) or die(" ". mysql_error());
	$count = 0;
	$records = 0;
	
	echo "All Search Results<br/><br/>";
	...
	while ($line = mysql_fetch_array($results, MYSQL_ASSOC)) {
		...
		echo "<td><img src='http://d2o0t5hpnwv4c1.cloudfront.net/622_scroll/01.jpg'></td>";
		/* echo '<img src="';
