...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
			...
			<link rel="Coagmento icon" type="image/x-icon" href="http://www.coagmento.org/fall2015intent/img/favicon.ico">
    ...
    <div id="container">
    	    <form action="loginOnSideBarAux.php" method=post>
    			...
    			<table>
    				<tr><td>Forget your password? <a style="color:blue;text-decoration:underline;cursor:pointer;font-size:12px;" onclick="javascript:window.open('http://coagmento.org/fall2015intent/services/generatePassword.php','Forgot Password','directories=no, toolbar=no, location=no, status=no, menubar=no, resizable=no,scrollbars=yes,width=520,height=300,left=400');return false;">Click here</a> to generate a new one.</td></tr>
    				<tr><td colspan=2><br/></td></tr>
    				<tr><td>
    	                    </td>
    	                    <td>
