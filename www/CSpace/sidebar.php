	...
	<script type="text/javascript">
		...
		setInterval ("getNotifications()", 7000);
                ...
                if (gup("flagLogin")=="true")
                    window._content.location = "http://www.coagmento.org/CSpace/"; //Due to Firefox security policies, it cannot load pages tha are out of the domain. It is possible, however, changing the properties
