...
<div id="container">
    ...
    <div id="box_right"><?php
        ...
        echo "<table style='font-size: 12px;'><tr><td valign=\"middle\">&nbsp;&nbsp;Welcome, <span style=\"font-weight:bold\">$userName</span> to your <a href='index.php?projects=all&objects=all&years=all&months=all&formSubmit=Submit'>CSpace</a><br/>&nbsp;&nbsp;Current login: $lastLogin<br/>&nbsp;&nbsp;Points earned: <a href='points.php'>$points</a><br/>&nbsp;&nbsp;You have <a href='projects.php?userID=$userID'>$projectNums projects</a> and <a href='collaborators.php?userID=1'>$collabNums collaborators</a></td></tr></table>";
        ?><p>Filter your results using dropdown boxes above. Click a thumbnail for details.</p><p>Click on your profile picture in the top-right corner for the menu.</p></div>
</div>
