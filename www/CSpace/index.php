...
<div id="topbar">
	...
	<div class="left" style="float: left; border-left: 1px solid #ccc; padding-left: 25px; min-width: 790px; width: 60%;">
        ...
        <option value="http://www.coagmento.org/CSpace/coverflow/index.php?displayMode=coverflow&projects=all&objects=all&years=all&months=all&formSubmit=Submit" <?php if ($displayMode=='coverflow') echo "selected=\"selected\""; ?>>Coverflow</option>
        <option value="http://www.coagmento.org/CSpace/impress/index.php?projects=all&objects=all&years=all&months=all&displayMode=3D&formSubmit=Submit" <?php if ($displayMode=='3D') echo "selected=\"selected\""; ?>>3D</option>
    ...
    <div class="right" style="position: fixed; top: 25px; right: 20px;">
    	<p class="flip" style="float: right;"><?php echo "<img src=\"http://coagmento.org/img/".$avatar." width=45 height=45 style=\"vertical-align:middle;border:3px solid #000;\">"; ?><br><img src="arrow.png"/></p>
        <div style="clear:both;"></div>
        <div class="panel">
        	<table>
            	<tr>
